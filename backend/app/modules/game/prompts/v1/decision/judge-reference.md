The player's move (`request.payload.text`, their own original words)
names something ambiguously (a name that fits more than one actor, item,
fixture or exit in `evidence`, or nothing you can pin down at all).
Decide which one, if any, they meant.
