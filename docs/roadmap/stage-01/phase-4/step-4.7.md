...
Binding contracts: `docs/roadmap/stage-01/phase-4/ui-spec.md` (layout truth) and
`docs/roadmap/stage-01/phase-4/shared-knowledge.md` (*Frontend conventions — delta*;
