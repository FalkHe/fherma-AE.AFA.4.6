...
Binding contracts: `docs/roadmap/stage-01/phase-4/shared-knowledge.md` (*Q4 fix
contract*) and the Phase-3 pins it protects
(`docs/roadmap/stage-01/phase-3/shared-knowledge.md` — *Chat response job &
stale-turn healing*, Landed decisions 3.5). Background:
`docs/roadmap/stage-01/phase-3/open-questions.md` Q4. Agent: **backend-dev**. Zero
...
- On success, remove Q4 from `docs/roadmap/stage-01/phase-3/open-questions.md` and
