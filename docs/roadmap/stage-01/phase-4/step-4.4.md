...
Binding contract: `docs/roadmap/stage-01/phase-4/shared-knowledge.md` (read fully —
...
2.3 (see `docs/roadmap/stage-01/phase-2/shared-knowledge.md` Landed decisions 2.3 and
