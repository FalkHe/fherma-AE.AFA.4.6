...
Binding contract: `docs/roadmap/stage-01/phase-5/shared-knowledge.md` (read fully —
D1 is the wire truth). Prior pins: the error-shape split in
`docs/roadmap/stage-01/phase-2/shared-knowledge.md` (~lines 693–702) and the JSON:API
