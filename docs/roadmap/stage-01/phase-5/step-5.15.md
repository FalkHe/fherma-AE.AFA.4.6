...
Binding contract: `docs/roadmap/stage-01/phase-5/shared-knowledge.md` (D8; also read
...
- Link check: `docs/general/architecture.md`, `docs/demo-walkthrough.md` (5.16 will
