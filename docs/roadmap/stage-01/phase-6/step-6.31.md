...
Binding contract: `docs/roadmap/stage-01/phase-6/shared-knowledge.md` (**the M4 row
of the milestone table is the checklist**; D7, D8, D9, D10, D11, D12 are
the contracts to prove or refute) and `docs/roadmap/stage-01/phase-6/ui-spec.md`
...
output) and `.claude/skills/qa-checklist/SKILL.md`. Agent: **qa** (qa-backend +
