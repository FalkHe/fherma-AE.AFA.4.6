...
Binding contract: `docs/roadmap/stage-01/phase-6/shared-knowledge.md` (**D5** — the
per-caller `context`/`min_level` table in `docs/roadmap/stage-01/phase-6/model-naming-data-model.md`
