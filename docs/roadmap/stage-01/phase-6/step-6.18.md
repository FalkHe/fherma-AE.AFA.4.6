...
Binding contract: `docs/roadmap/stage-01/phase-6/shared-knowledge.md` (**D4** including
...
`docs/roadmap/stage-01/phase-6/model-naming-data-model.md` §3 (slug policy), §7 rows N6/N7 (the
