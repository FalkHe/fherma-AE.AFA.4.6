...
Binding contract: `docs/roadmap/stage-01/phase-6/shared-knowledge.md` (**D2** — single
...
`docs/roadmap/stage-01/phase-6/model-naming-data-model.md` §3 (identity and slug), §4.2
