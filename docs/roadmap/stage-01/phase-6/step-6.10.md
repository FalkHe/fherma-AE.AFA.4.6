...
Binding contract: `docs/roadmap/stage-01/phase-6/shared-knowledge.md` (hard rules —
migration 2 of 4; D1 pins the shapes and the drop-with-warning semantics) and
`docs/roadmap/stage-01/phase-6/model-naming-data-model.md` §2.1 (buildingline + drift guard),
