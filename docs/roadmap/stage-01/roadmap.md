...
> **This is a planning record, not a description of the system.** For what
> actually exists, read [`../README.md`](../README.md) → `general/` and
> `modules/`. Where this document and the code disagree, the code wins.
>
> **Phases 0–5 are complete. Phase 6 is not.** Its identity track (6.9–6.21,
> 6.24–6.27) landed; the used-price track stopped after storage — 6.22, 6.23 and
> 6.28 never landed — and the documentation and acceptance steps (6.29–6.31)
> did not run. See [`../modules/used-prices.md`](../modules/used-prices.md).

Binding context: `docs/general/architecture.md`, `docs/general/backend-stack.md`,
`docs/general/frontend-stack.md`, `docs/general/project-vision.md`.
...
- **Four domain tools**: structured catalogue search, spec comparison,
  licence/fit checks (A2 compliance, rider fit), cost estimator. *(The landed
  registry is eight — those four plus `retrieve_bike_knowledge`,
...
`docs/roadmap/stage-01/phase-1/shared-knowledge.md`; UI specs live in
`docs/roadmap/stage-01/phase-1/ui-spec.md`.
...
`docs/roadmap/stage-01/phase-2/shared-knowledge.md`; UI specs live in
`docs/roadmap/stage-01/phase-2/ui-spec.md`.
...
`docs/roadmap/stage-01/phase-2b/shared-knowledge.md`.
...
is `docs/roadmap/stage-01/phase-3/shared-knowledge.md`; UI specs live in
`docs/roadmap/stage-01/phase-3/ui-spec.md`.
...
decision pending, see `docs/roadmap/stage-01/phase-4/open-questions.md` OQ4.

Re-sliced 2026-08-28 into two parallel tracks (backend ∥ frontend, max
effort 4 per step, three milestones) — binding contract:
`docs/roadmap/stage-01/phase-4/shared-knowledge.md`; UI:
`docs/roadmap/stage-01/phase-4/ui-spec.md`.

- **4.1** *(superseded — moved into Phase 3; see
    `docs/roadmap/stage-01/phase-4/step-4.1.md` for the mapping).*
- **4.2** *(split into 4.3–4.11; see `docs/roadmap/stage-01/phase-4/step-4.2.md`
    for the mapping).*
...
- **4.5 Concurrent-turn 409 race fix** (backend) — *dropped/deferred: the
    ...
    `docs/roadmap/stage-01/phase-4/open-questions.md` OQ4.*
...
Re-sliced 2026-08-28 into two parallel tracks (backend ∥ frontend, max
effort 4 per step, three milestones) — binding contract:
`docs/roadmap/stage-01/phase-5/shared-knowledge.md`; UI:
`docs/roadmap/stage-01/phase-5/ui-spec.md` (done at slicing time); open items:
`docs/roadmap/stage-01/phase-5/open-questions.md`. The phase is deliberately
...
identity (`docs/modules/model-naming.md`) and market price both.**
...
`docs/roadmap/stage-01/phase-6/shared-knowledge.md`; UI specs live in
`docs/roadmap/stage-01/phase-6/ui-spec.md`; open items in
`docs/roadmap/stage-01/phase-6/open-questions.md`. The schema and rendering rationale
are `docs/roadmap/stage-01/phase-6/model-naming-data-model.md` and
`docs/roadmap/stage-01/phase-6/model-naming-display-spec.md` — their `N1`–`N9` slices are
...
- **Variant-aware filtering.** With trims stored as `variants` JSONB deltas
  ...
  Sketched in `docs/roadmap/stage-01/phase-6/model-naming-data-model.md` §9.
...
| ≥ 3 tool calls | Phase 3 (eight tools registered) |
