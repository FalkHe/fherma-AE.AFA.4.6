...
Turns the binding domain knowledge in [`../model-naming.md`](../model-naming.md)
...
`docs/roadmap/phase-6/` in the usual shape (shared-knowledge, step files,
ui-spec).

Binding context: [`../architecture.md`](../architecture.md),
[`../backend-stack.md`](../backend-stack.md), the Phase-2/2b conventions
...
| Docs | `docs/ingestion.md`, `docs/model-naming.md`, `README.md`, `docs/core-requirements-checklist.md` | identity section, CLI reference, cross-link |
...
| ~~OQ-12~~ | ~~A rendered name can no longer contain a trim.~~ | **Closed by the owner's reaffirmation of D2.** Names carry manufacturer, model and year range; trims and type codes are separate UI elements. Recorded in `docs/model-naming.md`. |
