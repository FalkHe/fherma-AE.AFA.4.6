...
Binding contract: `docs/roadmap/phase-6/shared-knowledge.md` (D1 — the §2.5
variants shape and caps, D2 — one save, full-object replace) and
**`docs/roadmap/phase-6/ui-spec.md` §3.1, §3.2, §7** with
`docs/roadmap/model-naming-display-spec.md` §6.2 (editor layout), §6.5
