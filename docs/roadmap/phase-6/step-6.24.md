...
Binding contract: `docs/roadmap/phase-6/shared-knowledge.md` (D1, D2, D4,
D6, D13), **`docs/roadmap/phase-6/ui-spec.md` §0 (file map), §1, §2, §7
(i18n)** and `docs/roadmap/model-naming-display-spec.md` §6.1, §6.2, §11 —
