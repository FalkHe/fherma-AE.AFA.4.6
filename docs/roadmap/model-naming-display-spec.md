...
[`../model-naming.md`](../model-naming.md), which is the domain authority —
...
Read first: [`../frontend-stack.md`](../frontend-stack.md),
...
`seen → typing… → message` rhythm from `docs/architecture.md`; and answering it
