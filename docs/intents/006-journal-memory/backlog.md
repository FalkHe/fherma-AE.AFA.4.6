...
| 02 | The DM can search everything it has narrated in a campaign run by meaning, and can be handed the most recent narration when a run is picked up again | 01 | #31 | running |
