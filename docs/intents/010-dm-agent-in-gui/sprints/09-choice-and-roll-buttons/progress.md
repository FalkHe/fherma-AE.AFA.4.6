...
Round 5: changes-requested — both roll paths pass live (checks 1, 2 mostly, 4, 5); one goblin hit ended the turn without the damage tool being called (no hp change), and the narration described a hero at 0 HP as standing despite the mechanics summary saying DOWN.
