...
| 03 | A retryable failure is retried with backoff — each attempt visible in the log — and the failure line appears only once the attempts are spent | 02 | #3 | running |
