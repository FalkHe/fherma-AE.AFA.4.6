...
## Backlog proposals
- The ready-made hero's preview lists gear by content id (shepherds-knife); render the template names instead — one small polish, could ride with sprint 04.
...
Round 2: approve, no failed criteria (live run with the real model).
