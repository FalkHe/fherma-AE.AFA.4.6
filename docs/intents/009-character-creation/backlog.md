...
| 06 | Character creation opens as its own page where the player talks to the Tavern Keeper and watches the sheet fill beside the transcript | 05, 007/05 | #50 | running |
