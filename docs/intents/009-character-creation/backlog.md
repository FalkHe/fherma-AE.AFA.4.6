...
|---|---|---|---|---|
| 01 | The game knows the nine races, twelve classes, skills and alignments a player may pick, and the numbers each of them fixes | – | #45 | running |
| 02 | A character built from those facts gets correct ability scores, hit points, armour class and usable gear, and can be saved to a run in place of the ready-made hero | 01 | #46 | open |
