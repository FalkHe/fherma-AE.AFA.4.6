...
|---|---|---|---|---|
| 01 | Check content schema + `greenhollow` against the mechanics; add `Exit.id`/`Exit.kind`, item-template seed inventory; fix loader rules and shipped content | – | #21 | running |
