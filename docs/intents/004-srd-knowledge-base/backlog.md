...
| 02 | `app srd ingest --dry-run` fetches SRD 5.1 from the CC-BY source into `backend/content/srd/v1/`, reports how many citable chunks it would embed, and a changed upstream shows up as a git diff | – | #9 | running |
