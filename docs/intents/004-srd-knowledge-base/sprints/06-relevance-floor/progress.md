...
## Issues
- The measurement this sprint hangs on produced an uncomfortable result, reported rather than smoothed over: questions the rules answer and questions they do not **overlap**. The weakest genuine question scores 0.526, while five questions the rules genuinely do not cover score higher, up to 0.668. Each of those is a near miss — asking about a subclass or a setting the rules omit lands on a generic feature they do carry. A similarity score cannot tell "close topic, wrong rule" from "right rule".
