...
| 03 | Opening a way, moving, changing attitudes, leaving, finishing a run and recording what happened are lasting changes owned by the rules layer alone | 02 | #70 | running |
