...
| 04 | The game can load one complete, trustworthy picture of the current moment, plus older narrative memory when the player refers back to it | 03 | #71 | running |
