...
| 4 | done | `useSignIn` navigates before writing the cache and the ordering note is deleted; `RequireAnonymous` honours the remembered address. Deep link with query and fragment verified live |
| 5 | running | |
