...
| Doc | Contents |
|---|---|
| [architecture.md](architecture.md) | Short current-state index: tech stack, module list, game-agent summary — the first thing agents read |
...
| [general/game-flow.v2.md](general/game-flow.v2.md) | The current game loop implementation: five LangGraph nodes, typed effects and cursors, scheduling priority, registries, recovery and delivery sequence |
